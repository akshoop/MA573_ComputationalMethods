...
# only explicit boundary at 0
# special boundary condition at Smax last line 
# (based on Prof's piazza post when he explained the previous linearity condition)
A[0, :] = 0

A[-1, -1] = r*Smax/ds + 0.5*sigma**2*Smax**2/(ds**2) - r
A[-1, -2] = -sigma**2*Smax**2/(ds**2) - r*Smax/ds
A[-1, -3] = 0.5*sigma**2*Smax**2/(ds**2)
